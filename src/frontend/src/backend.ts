...
export class Backend implements backendInterface {
    ...
    async addAccount(arg0: bigint, arg1: string, arg2: string, arg3: bigint, arg4: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async addBankDetail(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async addStudent(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: string, arg5: string, arg6: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async addTransaction(arg0: string, arg1: string, arg2: bigint, arg3: string, arg4: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async deleteTransaction(arg0: bigint): Promise<Result> {
        if (this.processError) {
            try {
    ...
    async getAccountByNumber(arg0: string): Promise<Account> {
        if (this.processError) {
            try {
                const result = await this.actor.getAccountByNumber(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateAccount(arg0: bigint, arg1: string, arg2: string, arg3: bigint, arg4: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateBankDetail(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateBankDetail(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateStudent(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: bigint, arg5: string, arg6: string, arg7: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateTransaction(arg0: bigint, arg1: string, arg2: bigint, arg3: string, arg4: bigint): Promise<Result> {
        if (this.processError) {
            try {
